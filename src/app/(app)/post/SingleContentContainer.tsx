...
const SingleContentContainer: FC<Props> = ({ post, className, tags }) => {
  ...
  const { author, content, handle } = post
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className={`sticky bottom-8 z-11 mt-8 justify-center ${showLikeAndShareSticky ? 'flex' : 'hidden'}`}>
