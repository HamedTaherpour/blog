...
const styles = {
  ...
  outline: [
    ...
    // Icon
    '[--btn-icon:var(--color-primary-500)] data-active:[--btn-icon:var(--color-primary-700)] data-hover:[--btn-icon:var(--color-primary-700)] dark:data-active:[--btn-icon:var(--color-primary-400)] dark:data-hover:[--btn-icon:var(--color-primary-400)]',
  ],
  plain: [
    // Base
    ...
    // Icon
    '[--btn-icon:var(--color-primary-500)] data-active:[--btn-icon:var(--color-primary-700)] data-hover:[--btn-icon:var(--color-primary-700)] dark:[--btn-icon:var(--color-primary-500)] dark:data-active:[--btn-icon:var(--color-primary-400)] dark:data-hover:[--btn-icon:var(--color-primary-400)]',
  ],
  colors: {
    'dark/primary': [
      'text-white [--btn-bg:var(--color-primary-900)] [--btn-border:var(--color-primary-950)]/90 [--btn-hover-overlay:var(--color-white)]/10',
    ...
    light: [
      'text-primary-950 [--btn-bg:white] [--btn-border:var(--color-primary-950)]/10 [--btn-hover-overlay:var(--color-primary-950)]/[2.5%] data-active:[--btn-border:var(--color-primary-950)]/15 data-hover:[--btn-border:var(--color-primary-950)]/15',
      'dark:text-white dark:[--btn-hover-overlay:var(--color-white)]/5 dark:[--btn-bg:var(--color-primary-800)]',
      '[--btn-icon:var(--color-primary-500)] data-active:[--btn-icon:var(--color-primary-700)] data-hover:[--btn-icon:var(--color-primary-700)] dark:[--btn-icon:var(--color-primary-500)] dark:data-active:[--btn-icon:var(--color-primary-400)] dark:data-hover:[--btn-icon:var(--color-primary-400)]',
    ],
    'dark/white': [
      'dark:text-primary-500 text-white [--btn-bg:var(--color-primary-50)] [--btn-border:var(--color-primary-950)]/90 [--btn-hover-overlay:var(--color-white)]/10',
      'dark:text-primary-950 dark:[--btn-bg:white] dark:[--btn-hover-overlay:var(--color-primary-950)]/5',
      '[--btn-icon:var(--color-primary-400)] data-active:[--btn-icon:var(--color-primary-300)] data-hover:[--btn-icon:var(--color-primary-300)] dark:[--btn-icon:var(--color-primary-500)] dark:data-active:[--btn-icon:var(--color-primary-400)] dark:data-hover:[--btn-icon:var(--color-primary-400)]',
    ],
    dark: [
      'text-white [--btn-bg:var(--color-primary-900)] [--btn-border:var(--color-primary-950)]/90 [--btn-hover-overlay:var(--color-white)]/10',
      'dark:[--btn-hover-overlay:var(--color-white)]/5 dark:[--btn-bg:var(--color-primary-800)]',
      '[--btn-icon:var(--color-primary-400)] data-active:[--btn-icon:var(--color-primary-300)] data-hover:[--btn-icon:var(--color-primary-300)]',
    ],
    white: [
      'text-primary-950 [--btn-bg:white] [--btn-border:var(--color-primary-950)]/10 [--btn-hover-overlay:var(--color-primary-950)]/[2.5%] data-active:[--btn-border:var(--color-primary-950)]/15 data-hover:[--btn-border:var(--color-primary-950)]/15',
      'dark:[--btn-hover-overlay:var(--color-primary-950)]/5',
      '[--btn-icon:var(--color-primary-400)] data-active:[--btn-icon:var(--color-primary-500)] data-hover:[--btn-icon:var(--color-primary-500)]',
    ],
    zinc: [
...
export const Button = forwardRef(function Button(
  ...
  let classes = clsx(
    className,
    styles.base,
    outline ? styles.outline : plain ? styles.plain : clsx(styles.solid, styles.colors[color ?? 'dark/primary'])
  )
