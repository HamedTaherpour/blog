...
function TabsList({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.List>) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={clsx(
        'bg-primary-50 text-white inline-flex h-12 w-fit items-center justify-center rounded-lg p-[3px]',
        className
      )}
      {...props}
    />
